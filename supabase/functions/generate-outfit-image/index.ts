...
- Absolutely NO text, watermarks, logos, or overlays`;
    ...
    const geminiUrl = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash-preview-image-generation:generateContent?key=${GOOGLE_GEMINI_API_KEY}`;
